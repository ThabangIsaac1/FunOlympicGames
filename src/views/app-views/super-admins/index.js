...
export const AnalyticDashboard = () => {
  ...
  const subColumns = [
    { title: "Full Names", dataIndex: "fullName", key: "fullName" },
  ...
  const data = [
    {
      ...
      bronze: "2",
      total: "2",
      description: "Event Has Ended Video is still available for viewing. ",
    },
  ];
  const tableColumns = [
    {
              ...
              <Table
                ...
                expandable={{
                  expandedRowRender: (record) => (
                    <p style={{ margin: 0 }}>
                      Event Has taken place and above are the results. The video
